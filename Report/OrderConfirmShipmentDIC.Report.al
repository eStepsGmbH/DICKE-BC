report 50008 "Order Confirm. Shipment DIC"
{
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                begin
                    ...
                    //SalesPostPrepmt.BuildInvLineBuffer2("Sales Header",PrepmtSalesLine,0,PrepmtInvBuf); TODO: CHECK
            ...
            begin
                ...
                IF Print THEN BEGIN
                    IF CurrReport.USEREQUESTPAGE AND ArchiveDocument //OR
                                                                     //NOT CurrReport.USEREQUESTPAGE AND SalesSetup."Arch. Orders and Ret. Orders" TODO: CHECK
                    THEN
    ...
    requestpage
    {
        ...
        trigger OnOpenPage()
        begin
            //ArchiveDocument := SalesSetup."Arch. Orders and Ret. Orders"; TODO: CHEKC
